...
while (($row = $result11->fetch_assoc())) {
    $idq[$i] =  $row['appversion_id'];
    $versao11[$i] = $row['version'];
    $i++;
}
//print_r($versao9);
...
//JANEIRO 
for($i =0; $i < $maxi; $i++){
    $qAreaJAN = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 1 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaJAN=mysqli_query($conn, $qAreaJAN);
    if($qAreaJAN)
    {
        while($row=mysqli_fetch_assoc($qAreaJAN))
        {
            $areaJANEberick[$i] = $row['k'];
        }     
    }
}
//FEVEREIRO
for($i = 0; $i < $maxi; $i++){
    $qAreaFEV = "SELECT count(*) as R FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 2 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaFEV=mysqli_query($conn, $qAreaFEV);
    if($qAreaFEV)
    {
        while($row=mysqli_fetch_assoc($qAreaFEV))
        {
            $areaFEVEberick[$i] = $row['R'];
        }     
    }
}
//MARCO
for($i = 0; $i < $maxi; $i++){
    $qAreaMAR = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 3 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaMAR=mysqli_query($conn, $qAreaMAR);
    if($qAreaMAR)
    {
        while($row=mysqli_fetch_assoc($qAreaMAR))
        {
            $areaMAREberick[$i] = $row['k'];
        }     
    }
}
//ABRIL
for($i = 0; $i < $maxi; $i++){
    $qAreaABR = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 4 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaABR=mysqli_query($conn, $qAreaABR);
    if($qAreaABR)
    {
        while($row=mysqli_fetch_assoc($qAreaABR))
        {
            $areaABREberick[$i] = $row['k'];
        }     
    }
}
//MAIO
for($i = 0; $i < $maxi; $i++){
    $qAreaMAI = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 5 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaMAI=mysqli_query($conn, $qAreaMAI);
    if($qAreaMAI)
    {
        while($row=mysqli_fetch_assoc($qAreaMAI))
        {
            $areaMAIEberick[$i] = $row['k'];
        }     
    }
}
//JUNHO
for($i = 0; $i < $maxi; $i++){
    $qAreaJUN = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 6 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaJUN=mysqli_query($conn, $qAreaJUN);
    if($qAreaJUN)
    {
        while($row=mysqli_fetch_assoc($qAreaJUN))
        {
            $areaJUNEberick[$i] = $row['k'];
        }     
    }
}
//JULHO
for($i = 0; $i < $maxi; $i++){
    $qAreaJUL = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 7 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaJUL=mysqli_query($conn, $qAreaJUL);
    if($qAreaJUL)
    {
        while($row=mysqli_fetch_assoc($qAreaJUL))
        {
            $areaJULEberick[$i] = $row['k'];
        }     
    }
}
//AGOSTO
for($i = 0; $i < $maxi; $i++){
    $qAreaAGO = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 8 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaAGO=mysqli_query($conn, $qAreaAGO);
    if($qAreaAGO)
    {
        while($row=mysqli_fetch_assoc($qAreaAGO))
        {
            $areaAGOEberick[$i] = $row['k'];
        }     
    }
}
...
//SETEMBRO
for($i = 0; $i < $maxi; $i++){
    $qAreaSET = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 9 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaSET=mysqli_query($conn, $qAreaSET);
    if($qAreaSET)
    {
        while($row=mysqli_fetch_assoc($qAreaSET))
        {
            $areaSETEberick[$i] = $row['k'];
        }     
    }
}
//OUTUBRO
for($i = 0; $i < $maxi; $i++){
    $qAreaOUT = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 10 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaOUT=mysqli_query($conn, $qAreaOUT);
    if($qAreaOUT)
    {
        while($row=mysqli_fetch_assoc($qAreaOUT))
        {
            $areaOUTEberick[$i] = $row['k'];
        }     
    }
}
//NOVEMBRO
for($i = 0; $i < $maxi; $i++){
    $qAreaNOV = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 11 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaNOV=mysqli_query($conn, $qAreaNOV);
    if($qAreaNOV)
    {
        while($row=mysqli_fetch_assoc($qAreaNOV))
        {
            $areaNOVEberick[$i] = $row['k'];
        }     
    }
}
...
//DEZEMBRO
for($i = 0; $i < $maxi; $i++){
    $qAreaDEZ = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 12 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$idq[$i]' && project_id = 1";
    $qAreaDEZ=mysqli_query($conn, $qAreaDEZ);
    if($qAreaDEZ)
    {
        while($row=mysqli_fetch_assoc($qAreaDEZ))
        {
            $areaDEZEberick[$i] = $row['k'];
        }     
    }
}
...
while (($row = $result10->fetch_assoc())) {
    $ids[$i] =  $row['appversion_id'];
    $versao10[$i] = $row['version'];
    $i++;
}
//print_r($versao9);
...
//JANEIRO 
for($i =0; $i < $maxa; $i++){
    $qAreaJAN = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 1 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaJAN=mysqli_query($conn, $qAreaJAN);
    if($qAreaJAN)
    {
        while($row=mysqli_fetch_assoc($qAreaJAN))
        {
            $areaJANQibuilder[$i] = $row['k'];
        }     
    }
}
//FEVEREIRO
for($i = 0; $i < $maxa; $i++){
    $qAreaFEV = "SELECT count(*) as R FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 2 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaFEV=mysqli_query($conn, $qAreaFEV);
    if($qAreaFEV)
    {
        while($row=mysqli_fetch_assoc($qAreaFEV))
        {
            $areaFEVQibuilder[$i] = $row['R'];
        }     
    }
}
//MARCO
for($i = 0; $i < $maxa; $i++){
    $qAreaMAR = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 3 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaMAR=mysqli_query($conn, $qAreaMAR);
    if($qAreaMAR)
    {
        while($row=mysqli_fetch_assoc($qAreaMAR))
        {
            $areaMARQibuilder[$i] = $row['k'];
        }     
    }
}
//ABRIL
for($i = 0; $i < $maxa; $i++){
    $qAreaABR = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 4 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaABR=mysqli_query($conn, $qAreaABR);
    if($qAreaABR)
    {
        while($row=mysqli_fetch_assoc($qAreaABR))
        {
            $areaABRQibuilder[$i] = $row['k'];
        }     
    }
}
//MAIO
for($i = 0; $i < $maxa; $i++){
    $qAreaMAI = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 5 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaMAI=mysqli_query($conn, $qAreaMAI);
    if($qAreaMAI)
    {
        while($row=mysqli_fetch_assoc($qAreaMAI))
        {
            $areaMAIQibuilder[$i] = $row['k'];
        }     
    }
}
//JUNHO
for($i = 0; $i < $maxa; $i++){
    $qAreaJUN = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 6 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaJUN=mysqli_query($conn, $qAreaJUN);
    if($qAreaJUN)
    {
        while($row=mysqli_fetch_assoc($qAreaJUN))
        {
            $areaJUNQibuilder[$i] = $row['k'];
        }     
    }
}
//JULHO
for($i = 0; $i < $maxa; $i++){
    $qAreaJUL = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 7 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaJUL=mysqli_query($conn, $qAreaJUL);
    if($qAreaJUL)
    {
        while($row=mysqli_fetch_assoc($qAreaJUL))
        {
            $areaJULQibuilder[$i] = $row['k'];
        }     
    }
}
//AGOSTO
for($i = 0; $i < $maxa; $i++){
    $qAreaAGO = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 8 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaAGO=mysqli_query($conn, $qAreaAGO);
    if($qAreaAGO)
    {
        while($row=mysqli_fetch_assoc($qAreaAGO))
        {
            $areaAGOQibuilder[$i] = $row['k'];
        }     
    }
}
...
//SETEMBRO
for($i = 0; $i < $maxa; $i++){
    $qAreaSET = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 9 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaSET=mysqli_query($conn, $qAreaSET);
    if($qAreaSET)
    {
        while($row=mysqli_fetch_assoc($qAreaSET))
        {
            $areaSETQibuilder[$i] = $row['k'];
        }     
    }
}
//OUTUBRO
for($i = 0; $i < $maxa; $i++){
    $qAreaOUT = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 10 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaOUT=mysqli_query($conn, $qAreaOUT);
    if($qAreaOUT)
    {
        while($row=mysqli_fetch_assoc($qAreaOUT))
        {
            $areaOUTQibuilder[$i] = $row['k'];
        }     
    }
}
//NOVEMBRO
for($i = 0; $i < $maxa; $i++){
    $qAreaNOV = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 11 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaNOV=mysqli_query($conn, $qAreaNOV);
    if($qAreaNOV)
    {
        while($row=mysqli_fetch_assoc($qAreaNOV))
        {
            $areaNOVQibuilder[$i] = $row['k'];
        }     
    }
}
...
//DEZEMBRO
for($i = 0; $i < $maxa; $i++){
    $qAreaDEZ = "SELECT count(*) as k FROM crashfix.tbl_crashreport WHERE month(FROM_UNIXTIME(date_created)) = 12 && year(FROM_UNIXTIME(date_created)) = '$anoselecionado' && appversion_id = '$ids[$i]' && project_id = 2";
    $qAreaDEZ=mysqli_query($conn, $qAreaDEZ);
    if($qAreaDEZ)
    {
        while($row=mysqli_fetch_assoc($qAreaDEZ))
        {
            $areaDEZQibuilder[$i] = $row['k'];
        }     
    }
}
